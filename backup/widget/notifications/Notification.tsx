...
export default function Notification({
    ...
    return (
        <Adw.Clamp maximumSize={400}>
            ...
            >
                {/* Agregamos el controlador de movimiento manualmente */}
                {motionController}
                ...
                <box class="header">
                    ...
                    <button
                        onClicked={() => {
                            dismissed = true;
                            n.dismiss(); // Esto probablemente emite el evento 'resolved'
                            onHoverLost(); // Solo eliminamos del estado si aún no lo hizo
                        }}
                    >
